...
public class SitetemplateDaoImpl implements SitetemplateDao {
	...
	public ArrayList<NewsSitetemplate> getSiteByLanguageAndLocation(DatabaseStatus dbStatus,int language,int locations){
		String sql="";
		...
		ArrayList<NewsSitetemplate> rs = new ArrayList();
		try {
			rs = (ArrayList<NewsSitetemplate>) jdbcTemplate.query(sql,
					new NewsSitetempalteMapper());
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ArrayList<NewsSitetemplate> getAllAvailableTemplate() {
		...
		ArrayList<NewsSitetemplate> rs = (ArrayList<NewsSitetemplate>) jdbcTemplate
				.query(sql, new NewsSitetempalteMapper());
		return rs;
	}
