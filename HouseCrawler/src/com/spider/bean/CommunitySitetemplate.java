...
public class CommunitySitetemplate {
     ...
     * 物业公司
     */
    private String companyxpath;
    /**
     * 开放商
     */
    private String devcompanyxpath;
    /**
     * 容积率
     */
     ...
     * 绿化率
     */
    private String greenxpath;
    /**
     * 大字段数据Xpath（图片会从这个内容中获取）（购房指引）
     */
    ...
    public String getCompanyxpath() {
        return companyxpath;
    }
    public void setCompanyxpath(String companyxpath) {
        this.companyxpath = companyxpath;
    }
    public String getDevcompanyxpath() {
        return devcompanyxpath;
    }
    public void setDevcompanyxpath(String devcompanyxpath) {
        this.devcompanyxpath = devcompanyxpath;
    }
    ...
    public String getGreenxpath() {
        return greenxpath;
    }
    public void setGreenxpath(String greenxpath) {
        this.greenxpath = greenxpath;
    }
