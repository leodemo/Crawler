...
public class HouseSpiderControl {
    private static Logger MainLogger =
            Logger.getLogger(HouseSpiderControl.class);
    //	对本地数据库进行重连
    ...
    public static void main(String args[]) {
        ...
        UrlDao urlDao = (UrlDaoImpl) context.getBean("houseurl");
        DataDao dataDao = (HouseDaoImpl) context.getBean("house");
        ...
        while (true) {
            ...
            // 获取house模板
            ArrayList<HouseSitetemplate> siteList = (ArrayList<HouseSitetemplate>)sitetemplateDao
...
//            conSynThread.start();
            ...
            for (int i = 0; i < urlSpiderThreadNum; i++) {
                MultiUrlSpider urlSpider = new MultiUrlSpider(urlDao,contentCount, config, i, urlSpiderThreadNum,
                        dbStatus);
                urlSpider.setHouseSiteTemplateList(siteList);
            ...
            for (int i = 0; i < contentSpiderThreadNum; i++) {
                ...
                contentSpider.setHouseSiteList(siteList);
